...
public class Mercadoria {
    ...
    public Mercadoria(String id, String descricao, String tipo, double peso, double volume, TagIoT tagIoT, LocalDate validade) {
        this.id = id;
    ...
    public String toString() {
        return String.format("Mercadoria[id=%s, descricao=%s, tipo=%s, peso=%.2f, volume=%.2f]", id, descricao, tipo, peso, volume);
    }
